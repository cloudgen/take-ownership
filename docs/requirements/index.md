...
| requirement-project-folder | Project layout (`src/`), install bins, config drafts; preferred cache `/dev/shm/cache/cache-${APP_NAME}`; persist `${HOME}/.local/${APP_NAME}/`; **no** `/var/backup` | architecture | Active (2.1.0) | `requirement-project-folder.md` | 2026-08-30 |
