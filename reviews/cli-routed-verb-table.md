...
| generate-sudoer-json | `to_generate_sudoer_request` | you | 2026-08-26 | test-purpose | generate-sudoer-json: Write the canonical JSON grant for tests (ownership stays *) |
...
**Main menu** uses only **operational** rows other than `menu`/`main`: action, list-folders, remove-project-sudoers, submit-sudoer-request. Self-managed, diagnostics, and test-purpose stay off the numbered list.
